// -----------------------------------------------------------------------
// <copyright file="_234TreeNode.cs" company="">
...
namespace ForRest._234Tree
{
    ...
    public class _234TreeNode<T> : Node<T>
    {
        ...
        public void UpdateNodesInfo()
        {
            ...
            if (Neighbors != null)
                foreach (Node<T> n in Neighbors)
                    ((_234TreeNode<T>)n).UpdateNodesInfo();
        }
        ...
        /// <summary>
        /// Indicates whether _234TreeNode has at least maximal nuber of values
        /// </summary>
        public bool IsFull
        {
            get
        ...
        /// <summary>
        /// Indicates whether _234TreeNode has at most minimal nuber of values
        /// </summary>
        public bool IsHalf
        {
            get
        ...
        /// <summary>
        /// Indicates whether _234TreeNode has less than minimal nuber of values
        /// </summary>
        ...
        public _234TreeNode<T> Split()
        {
            ...
            Values.Clear();
            _234TreeNode<T> leftNode = new _234TreeNode<T>(this.Parent, leftData, leftNeighbors);
            leftNode.isLeaf = false;
            _234TreeNode<T> rightNode = new _234TreeNode<T>(this.Parent, rightData, rightNeighbors);
        ...
        public _234TreeNode<T> Split(T data)
        {
            ...
            Values.Clear();
            _234TreeNode<T> leftNode = new _234TreeNode<T>(this.Parent, leftData);
            _234TreeNode<T> rightNode = new _234TreeNode<T>(this.Parent, rightData);
