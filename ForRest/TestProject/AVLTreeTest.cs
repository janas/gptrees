...
namespace TestProject
{
    ...
    public class AVLTreeTest
    {
        ...
        /// <summary>
        ///A test for AVLTree`1 Constructor
        ///</summary>
        public void AVLTreeConstructorTestHelper<T>()
        {
        ...
        {
            AVLTreeConstructorTestHelper<GenericParameterHelper>();
        }
        ...
        {
            AVLTree<T> target = new AVLTree<T>(); // TODO: Initialize to an appropriate value
