// --------------------------------------------------------------------------------------------------------------------
// <copyright file="_23TreeNode.cs" company="Warsaw University of Technology">
//   
// </copyright>
// <summary>
//   The _23 tree node.
...
namespace ForRest._23Tree
{
    ...
    public class _23TreeNode<T> : Node<T>
    {
        ...
        public override Node<T> Parent
        {
            ...
            set
            {
                this._parent = (_23TreeNode<T>)value;
            }
        }
        ...
        {
            return (_23TreeNode<T>)this.Neighbors[i];
        }
        ...
        public _23TreeNode<T> Split()
        {
            ...
            this.Values.Clear();
            var leftNode = new _23TreeNode<T>((_23TreeNode<T>)this.Parent, leftData, leftNeighbors) { IsLeaf = false };
