// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RedBlackTree.cs" company="Warsaw University of Technology">
//   
// </copyright>
// <summary>
//   The red black tree.
...
namespace ForRest.RedBlackTree
{
    ...
    public class RedBlackTree<T> : Tree<T>
    {
        ...
        public override Node<T> Root
        {
            ...
            set
            {
                this._root = (RedBlackTreeNode<T>)value;
            }
        }
        ...
        public override void Add(T data)
        {
            ...
            RedBlackTreeNode<T> current = this._root, parent = null;
            int result;
            while (current != null)
            {
            ...
            {
                this._root = (RedBlackTreeNode<T>)this._root.Parent;
            }
